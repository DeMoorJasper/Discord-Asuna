...
export class PermissionsHandler {
    ...
    static hasPermission(channel, member, permission) {
    ...
    static isAdmin = (channel, member) => {
        return PermissionsHandler.hasPermission(channel, member, permissionFlags.General.administrator);
    }
}